...
const u8 *const gItemEffectTable[ITEMS_COUNT] =
{
    ...
    [ITEM_VENUSAURITE]        = gItemEffect_EvoItem,
    [ITEM_CHARIZARDITE_X]     = gItemEffect_EvoItem,
    [ITEM_CHARIZARDITE_Y]     = gItemEffect_EvoItem,
    [ITEM_BLASTOISINITE]      = gItemEffect_EvoItem,
    [ITEM_BEEDRILLITE]        = gItemEffect_EvoItem,
    [ITEM_PIDGEOTITE]         = gItemEffect_EvoItem,
    [ITEM_ALAKAZITE]          = gItemEffect_EvoItem,
    [ITEM_SLOWBRONITE]        = gItemEffect_EvoItem,
    [ITEM_GENGARITE]          = gItemEffect_EvoItem,
    [ITEM_KANGASKHANITE]      = gItemEffect_EvoItem,
    [ITEM_PINSIRITE]          = gItemEffect_EvoItem,
    [ITEM_GYARADOSITE]        = gItemEffect_EvoItem,
    [ITEM_AERODACTYLITE]      = gItemEffect_EvoItem,
    [ITEM_MEWTWONITE_X]       = gItemEffect_EvoItem,
    [ITEM_MEWTWONITE_Y]       = gItemEffect_EvoItem,
    [ITEM_AMPHAROSITE]        = gItemEffect_EvoItem,
    [ITEM_STEELIXITE]         = gItemEffect_EvoItem,
    [ITEM_SCIZORITE]          = gItemEffect_EvoItem,
    [ITEM_HERACRONITE]        = gItemEffect_EvoItem,
    [ITEM_HOUNDOOMINITE]      = gItemEffect_EvoItem,
    [ITEM_TYRANITARITE]       = gItemEffect_EvoItem,
    [ITEM_SCEPTILITE]         = gItemEffect_EvoItem,
    [ITEM_BLAZIKENITE]        = gItemEffect_EvoItem,
    [ITEM_SWAMPERTITE]        = gItemEffect_EvoItem,
    [ITEM_GARDEVOIRITE]       = gItemEffect_EvoItem,
    [ITEM_SABLENITE]          = gItemEffect_EvoItem,
    [ITEM_MAWILITE]           = gItemEffect_EvoItem,
    [ITEM_AGGRONITE]          = gItemEffect_EvoItem,
    [ITEM_MEDICHAMITE]        = gItemEffect_EvoItem,
    [ITEM_MANECTITE]          = gItemEffect_EvoItem,
    [ITEM_SHARPEDONITE]       = gItemEffect_EvoItem,
    [ITEM_CAMERUPTITE]        = gItemEffect_EvoItem,
    [ITEM_ALTARIANITE]        = gItemEffect_EvoItem,
    [ITEM_BANETTITE]          = gItemEffect_EvoItem,
    [ITEM_ABSOLITE]           = gItemEffect_EvoItem,
    [ITEM_GLALITITE]          = gItemEffect_EvoItem,
    [ITEM_SALAMENCITE]        = gItemEffect_EvoItem,
    [ITEM_METAGROSSITE]       = gItemEffect_EvoItem,
    [ITEM_LATIASITE]          = gItemEffect_EvoItem,
    [ITEM_LATIOSITE]          = gItemEffect_EvoItem,
    [ITEM_LOPUNNITE]          = gItemEffect_EvoItem,
    [ITEM_GARCHOMPITE]        = gItemEffect_EvoItem,
    [ITEM_LUCARIONITE]        = gItemEffect_EvoItem,
    [ITEM_ABOMASITE]          = gItemEffect_EvoItem,
    [ITEM_GALLADITE]          = gItemEffect_EvoItem,
    [ITEM_AUDINITE]           = gItemEffect_EvoItem,
    [ITEM_DIANCITE]           = gItemEffect_EvoItem,
    [ITEM_RED_ORB]            = gItemEffect_EvoItem,
    [ITEM_BLUE_ORB]           = gItemEffect_EvoItem,
